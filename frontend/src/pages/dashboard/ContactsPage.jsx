          ...
          <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
            ...
            <DialogContent>
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Input placeholder="9876543210" className="flex-1" />
                  </div>
                </div>
                <div className="space-y-2">
                  <Label>Email</Label>
              ...
              <DialogFooter>
                ...
                <Button className="bg-orange-500 hover:bg-orange-600">Add Contact</Button>
              </DialogFooter>
            </DialogContent>
          </Dialog>
        </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-slate-900">15,832</p>
              </div>
                ...
                <TableBody>
                  {contacts.map((contact) => (
                    <TableRow key={contact.id} className="table-row-hover">
                      ...
                      <TableCell>
                        <Badge className={contact.optIn ? "bg-green-100 text-green-700 hover:bg-green-100" : "bg-red-100 text-red-700 hover:bg-red-100"}>

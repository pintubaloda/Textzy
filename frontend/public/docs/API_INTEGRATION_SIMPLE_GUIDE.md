...
- HTTPS is mandatory
- `X-Tenant-Slug` is still required for tenant APIs
...
### 2.3 API key auth configuration
Set in platform settings scope: `api-integration`
- `enabled`: `true` or `false`
- `apiKey`
- `apiSecret`
- `ipWhitelist` (optional, comma/newline separated IP/CIDR, for example `203.0.113.10, 203.0.113.0/24`)

Fallback env keys:
- `IntegrationApi:ApiKey`
- `IntegrationApi:ApiSecret`
- `IntegrationApi:IpWhitelist`
